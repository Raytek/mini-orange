...
local volumebar_widget = require("utils.volumebar")
-- Battery widget
-- local battery_widget = require("utils.battery")
local batteryarc_widget = require("utils.batteryarc")
...
beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/mini_orange/theme.lua")
    ...
    s.mywibox:setup {
	   ...
	   -- }),
	    batteryarc_widget({
	       ...
	       arc_thickness = 1,
	       main_color = '#F47B14',
	       contrast_color = '#F47B14',
	       low_level_color = '#F47B14',
	       medium_level_color = '#F47B14',
	       charging_color = '#F47B14'
	    }),
            mykeyboardlayout,
            mytextclock,
            s.mylayoutbox,
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"}, "s", function () xrandr.xrandr() end,
              {description = "helper for multiple monitors", group = "screen"}),
    ...
    awful.key({ modkey, "Shift" }, "i", function() awful.spawn(ide) end,
              {description = "ide", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "b", function() awful.spawn(browser) end,
              {description = "browser", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "v", function() awful.spawn(veditor) end,
              {description = "text editor", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "\\", function() awful.spawn(chat) end,
              {description = "chat manager", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    {description = "desmaximize", group = "client"})
)
