...
local function worker(args)
    ...
    local contrast_color = args.contrast_color or beautiful.fg_color
    ...
    local warning_msg_icon = args.warning_msg_icon or HOME .. '/.config/awesome/icons/spaceman.jpg'
    ...
    watch("acpi -i", 10,
            function(widget, stdout)
                ...
                if status == 'Charging' then
                    ...
                    text_with_background.fg = contrast_color
                else
